...
\begin{figure}[h!]
\includegraphics[]{analysis/image/notebook-googlesheets-presentation.png}
\caption{}
\end{figure}
...
\begin{figure}[h!]
\includegraphics[]{analysis/image/notebook-plot1.png}
\caption{}
\end{figure}
...
![Paramètres filtrables](analysis/image/notebook-plot2.png)
...
<!-- ![Feuille Google Sheets](analysis/image/notebook-googlesheets0.png) -->

\begin{figure}[h!]
\includegraphics[]{analysis/image/notebook-googlesheets0.png}
\caption{}
\end{figure}
<br/><br/>
...
\begin{figure}[h!]
\includegraphics[]{analysis/image/notebook-googlesheets1.png}
\caption{}
\end{figure}
...
<br/>
<!-- ![Format du fichier partagé](analysis/image/notebook-googlesheets2.png) -->
\begin{figure}[h!]
\includegraphics[]{analysis/image/notebook-googlesheets2.png}
\caption{}
\end{figure}
