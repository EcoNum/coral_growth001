...
sont au nombre de 84, toutes suspendues dans l'eau à l'aide de fil de
pêche sur une règle qui porte un numéro d'identification propre à chaque
bouture (Fig. ???).
...
Le tableur est en ligne cela permet à n'importe qui, qui a besoin de
remplir un tableau de donnée puisse le faire depuis n'importe quelle
...
suivant l'avancement des données.
